import {idValidator, ValidationResult} from '../../common';
import {parametrizedFieldTypeFactory, simpleFieldTypeFactory} from './field-type';
import {parametrizedFieldValidatorFactory} from './field-value-validation';
...
export default class DefaultContentLayer implements ContentLayer<void> {
  fieldTypeFactories = [
      id,
      text,
      number,
